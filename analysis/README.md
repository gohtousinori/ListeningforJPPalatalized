...
```r
install.packages(c("dplyr", "readr", "stringr", "tidyr", "purrr", "lme4", "broom.mixed"))
```

### 2) Run script

```bash
Rscript analysis/run_glmm_ttest.R path/to/details.csv path/to/summary.csv analysis/output
```
